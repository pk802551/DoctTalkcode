        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-md-12 text-center text-lg-start">
            <h1 className="heading mb-4">
              Each session of the mentorship program comprises
            </h1>
            <h2 className="subheading">Expert Insights & Solutions</h2>
            <p className="description mb-4">
              Each session of the mentorship program comprises expert guidance
              and tailored strategies to help businesses innovate and thrive. We
              empower organizations across various industries, including
